...
export const mockWeeklyUpdates: WeeklyUpdate[] = [
  {
    ...
    "content": "Foram incorporados 46 registros reais de alarmes disponiveis na base para o cliente Serasa Experian, com destaque para os equipamentos mais reincidentes.",
